...
import { LayoutDashboard, FolderKanban, GanttChart, Users, BarChart3, UserCog, Shield, ShieldCheck, Settings, CheckSquare, Clock, Activity, ClipboardCheck, LogOut, ChevronLeft, ChevronRight, Globe, Inbox, Plane, CalendarClock, Sun, Sunrise, Waves, UsersRound, BookOpen, Bot, Cpu, Radio } from 'lucide-react';
...
const iconMap: Record<string, React.ComponentType<any>> = {
  LayoutDashboard, FolderKanban, GanttChart, Users, BarChart3, UserCog, Shield, ShieldCheck, Settings, CheckSquare, Clock, Activity, ClipboardCheck, Globe, Inbox, Plane, CalendarClock, Sun, Sunrise, Waves, UsersRound, BookOpen, Bot, Cpu, Radio,
};
