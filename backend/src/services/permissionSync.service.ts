...
const PERMISSION_DEFINITIONS: Array<{ key: string; label: string; category: string }> = [
  ...
  { key: PERMISSIONS.CMS_CONTENT_ENGINE_USE, label: 'Use Content Engine', category: 'cms' },
  { key: PERMISSIONS.CMS_APIKEY_VIEW, label: 'View Project API Key', category: 'cms' },
  { key: PERMISSIONS.CMS_APIKEY_MANAGE, label: 'Manage Project API Key', category: 'cms' },
